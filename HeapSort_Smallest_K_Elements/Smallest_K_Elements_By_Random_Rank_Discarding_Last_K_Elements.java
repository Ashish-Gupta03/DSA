 ...
 class Solution
{
	public static void main(String args[])throws Exception
	{
		...
		//int[] arr={92,-1,6,-8,9,11,99,10,59,56,68,86,85,90,69,-4,-5,3,9};
		int k=10000;
	...
	static void buildMaxHeap(int[] arr,int k)
	{
		...
		// for(i=0;i<=size;i++)
		// 	out.print(res[i]+" ");
		int element=findRank(res,0,size,k+1);
		//out.println("element before loop is "+element);
		...
		{			
			...
			{
				k=temp;
				element=findRank(res,0,res.length-1,k+1);
			}
		}
		k=temp;
